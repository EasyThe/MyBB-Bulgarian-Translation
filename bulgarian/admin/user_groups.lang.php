 ...
 *
 * $Id: user_groups.lang.php 5755 2012-03-09 15:02:5 $
 */
...
$l['moderate_join_requests'] = "Да, всяка молба молба за регистриране първо трябва да бъде модерирана<br /><small>За да бъде активна опцията потребители телите трябва да могат свободно да се присъединяват и напускат.</small>";
...
$l['required_posts_desc'] = "Here you can enter the minimum number of posts a user must have before they can add a signature.";
...
$l['can_email_users_override'] = "Могат да изпращат ел. писма на потребителите, които са в списъка им за игнориране?";
